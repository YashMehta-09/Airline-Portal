			...
			if (tstatus.contains("Reserve")) {
				...
				if (updateStatus) {
					...
					if (ticket.getStatus().contains("Economy")) {
						...
						seatUp = seat.updateSeat(ticket.getFlight().getEconomySeat(), ticket.getFlight().getFlightId(),
								ticket.getPassengerCount(), type);
						...
						seatUp = seat.updateSeat(ticket.getFlight().getBusinessSeat(), ticket.getFlight().getFlightId(),
								ticket.getPassengerCount(), type);
				...
				if (ticket.getStatus().contains("Economy")) {
					...
					seatUpdate = seat.updateSeat(ticket.getFlight().getEconomySeat(), ticket.getFlight().getFlightId(),
							ticket.getPassengerCount(), type);
					...
					seatUpdate = seat.updateSeat(ticket.getFlight().getBusinessSeat(), ticket.getFlight().getFlightId(),
							ticket.getPassengerCount(), type);
